...
class ConsistentHalfPatchTwoTypesResized(object):
    def __init__(self, prob, portion_range=[0.1,0.6], img_size=64):
        self.prob = prob
        self.occlusion_range = portion_range      
    ...
    def __call__(self, video):
        ...
        f, h, w = video.shape
        occ_portion = random.uniform(self.occlusion_range[0], self.occlusion_range[1])
        ...
        #print(f"consistent2types occlusion: {occ_portion}, visible shape: {visible.shape}")
        return visible
